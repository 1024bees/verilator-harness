...
VL_MODULE(Vtop) {
  public:
    ...
    struct {
        ...
        WData/*135:0*/ top__DOT__gen1____DOT__gen2____DOT__example__DOT__flops[4][16][5];
        WData/*135:0*/ top__DOT__gen1____DOT__gen2____DOT__example__DOT__flops_next[4][16][5];
    };    
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
